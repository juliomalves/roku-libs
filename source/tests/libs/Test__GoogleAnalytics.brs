...
function TestSuite__GoogleAnalytics() as Object
    ...
    this.addTest("should create global object with expected functions", TestCase__GoogleAnalytics_Functions)
...
sub GoogleAnalyticsTestSuite__SetUp()
    ...
    ' Override default properties/functions for testing purposes
    ...
    m.testObject._getCacheBuster = function()
        return "1"
    end function
...
function TestCase__GoogleAnalytics_Functions()
    ...
    result = m.assertNotInvalid(getGlobalAA()["analytics"])
...
function TestCase__GoogleAnalytics_BatchRequest()
    ...
    result += m.assertArrayCount(dataArr, expectedData.count())
